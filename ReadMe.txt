### Проект реализует решение задaчи для дильтрации полетов.
...
Проект — реализация модуля, который будет заниматься фильтрацией набора перелётов согласно различным правилам. 
> - Правил фильтрации может быть очень много. 
> -Наборы перелётов также могут быть очень большими.
> - Правила могут выбираться и задаваться динамически в зависимости от контекста выполнения операции фильтрации.

Приложение выдает в консоль результаты обработки тестового набора перелётов. 
Из тестового набора нужно исключить перелёты по следующим правилам (по каждому правилу нужен отдельный вывод списка перелётов):
